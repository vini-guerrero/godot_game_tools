...
class _PT_TILESET_GENERATOR_PT_(bpy.types.Panel, ObjectButtonsPanel):
    ...
    def draw(self, context):
        ...
        box.operator("wm.tileset_set_topdown_camera", icon="CAMERA_DATA")
        box.operator("wm.tileset_set_isometric_camera", icon="CAMERA_DATA")
        box.operator("wm.tileset_generate_tile", icon="PLUS")
        box.operator("wm.tileset_move_camera_tile", icon="ANIM_DATA")
        box.operator("wm.tileset_export_godot_tileset", icon="ASSET_MANAGER")
